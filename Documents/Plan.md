...
**Тестирование**
* Покупка тура через кнопку "Купить","Купить в кредит" с главной страницы сервиса
* Шаги по воспроизведению:
1. На главной странице сервиса нажимаем на кнопку "Купить","Купить в кредит";
2. Заполняем форму заявки полностью валидными данными карты.
...
8. Faker - генерация пользовательских данных (имени и телефона);
9. Lombok- библиотека для сокращения количества шаблонного кода, для объявления локальной переменной вместо указания реального типа;
